...
export const RAW_ITINERARY: Omit<ItineraryItem, "isEvening">[] = [
  ...
  { day: "יום ב", date: "27/04/2026", time: "18:30-20:30", activity: "גבעת ליקבטוס + שקיעה", location: "Lycabettus Hill", description: "הגבעה הכי גבוהה באתונה (277מ'). נוף פנורמי. שקיעה ~20:15 — לא לפספס!", notes: "רכבל תת-קרקעי — 3 דקות. להגיע ב-18:30!", accessible: "כן — רכבל", price: "13€ הלוך-חזור", travelTo: "🚕 ~15 דק' מהמלון" },
  ...
  { day: "יום ד", date: "29/04/2026", time: "11:00-13:00", activity: "מונסטיראקי ושוק הפשפשים", location: "Monastiraki Square", description: "שוק פשפשים ססגוני. תכשיטים, ביגוד, עתיקות, מזכרות.", notes: "שטוח, הרבה ספסלים לסבתא", accessible: "כן — שטוח", price: "כניסה חופשית", travelTo: "🚶 ~5 דק' מפסירי" },
