...
export const RAW_ITINERARY: Omit<ItineraryItem, "isEvening">[] = [
  ...
  { day: "יום א", date: "26/04/2026", time: "13:30", activity: "צהריים — Shuk (בשרי)", location: "Ermou 117", description: "", notes: "הזמינו מקום ל-13!", accessible: "כן", price: "~20-25€/אדם", mapQuery: "Shuk Restaurant Athens" },
  ...
  { day: "יום ב", date: "27/04/2026", time: "13:30", activity: "צהריים — Gostijo (בשרי)", location: "Esopou 10", description: "ממש ליד מונסטיראקי. פותח ב-13:30. יש מכולת כשרה בפנים.", notes: "לאשר זמינות ל-13", accessible: "כן", price: "~20-25€/אדם" },
  ...
  { day: "יום ד", date: "29/04/2026", time: "13:00-14:00", activity: "מוזיאון האשליות", location: "Museum of Illusions Athens", description: "אשליות אופטיות ותמונות אינטראקטיביות. ~60 דקות. כיפי לכל הגילאים!", notes: "לשאול על הנחות קבוצה ל-13", accessible: "כן", price: "~13€/אדם" },
  { day: "יום ד", date: "29/04/2026", time: "14:15", activity: "צהריים — Shuk (בשרי)", location: "Ermou 117", description: "5 דקות הליכה מהמוזיאון", notes: "", accessible: "כן", price: "~20-25€/אדם", mapQuery: "Shuk Restaurant Athens" },
...
export const TASKS: Task[] = [
  ...
  { task: "הזמנת מיניבוס ליאנה — הגעה מהשדה (26/4)", done: false, contact: "https://wa.me/message/NLNHNSS46SLHE1", notes: "13 איש + מזוודות. נסיעה ~45 דק" },
